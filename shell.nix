...
pylode = python37.pkgs.buildPythonPackage rec {
  pname = "pylode";
  version = "1.9";
  ...
  # '';
  # checkInputs = [ python37.pkgs.py python37.pkgs.pytest python37.pkgs.pytest-datafiles python37.pkgs.mock python37.pkgs.pytest-mock python37.pkgs.pytestrunner pkgs.python37Packages.wheel python37.pkgs.setuptools_scm ];

  # nativeBuildInputs = [ python37.pkgs.setuptools_scm python37.pkgs.wheel ];

  propagatedBuildInputs = [ python37.pkgs.setuptools_scm python37.pkgs.rdflib python37.pkgs.jinja2 python37.pkgs.dateutil python37.pkgs.gunicorn argparse ];
